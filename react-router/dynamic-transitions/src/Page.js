...
const Page = ({ history, to, ...props }) => (
  <Wrapper {...props}>
    ...
    <Footer>
      <a href="https://github.com/nicgirault/dynamic-transitions">
        Source code
      </a>
      <a href="https://medium.com/lalilo/dynamic-transitions-with-react-router-and-react-transition-group-69ab795815c9">
        Related article
      </a>
    </Footer>
  </Wrapper>
